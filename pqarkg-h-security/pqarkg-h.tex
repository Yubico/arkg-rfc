...
\begin{align*}
  \algblcheck(\barvar\skp,\barvar\pkstar)
  &= \algblcheck(\barvar\skp, \algblbpk(\algblupk(\barvar{\pkstar}, \barvar{\bstar}), \barvar{\bstar})) \\
  &= \algblcheck(\barvar\skp, \algblbpk(\pkstar, \barvar{\bstar})) \\
